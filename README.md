...
> HTML, CSS and using linters to sort out any issues with the code.
...
```sh
    ...
    git clone https://github.com/peter-mwovi/hello_microverse_project.git
```
...
I would like to thank Microverse for providing me with the necessary knowledge to work on such a project.
